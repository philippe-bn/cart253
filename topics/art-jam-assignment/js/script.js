...
/**
 * Creates body parts objects
 */
// Creates an elbow object
let elbow = {
    x: 130,
    y: 560
}

// Creates a forearm object
let forearm = {
    x: 0,
    y: -160
}
...
// Creates the corners of my mouth as an object
let mouth = {
    y1: 400,
    bezier1: 440,
    bezier2: 420,
...
// Creates my left eye as an object
let leftEye = {
    x: 370,
    y: 340,
    size: 25
...
// Creates my right eye as an object
let rightEye = {
    x: 425,
    y: 340,
    size: 25
